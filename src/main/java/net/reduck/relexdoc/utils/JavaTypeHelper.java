package net.reduck.relexdoc.utils;
...
import static net.reduck.relexdoc.utils.ValidateUtil.isEmpty;

/**
 * @author Gin
 * @since 2023/7/20 09:31
 */
public class JavaTypeHelper {
    ...
    public static boolean isClassName(String className) {
        if (isEmpty(className) || !className.contains(".")) {
            return false;
        }
